...
const schedule = ["Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Воскресенье"];
const principles = [
...
export default function Home() {
  return (
    <main>
      ...
      <section className="creator wrap"><div className="portrait"><span>ЛГ</span><small>Место для фотографии<br/>Лидии Гуринович</small></div><div><p className="eyebrow">Знакомство с создателем</p><h2>Я знаю, как нужен свет, когда берега не видно</h2><p>Меня зовут <b>Лидия Гуринович</b>. Я психолог и прошла через БАР 2 типа и депрессивные эпизоды, была участницей и ведущей сообщества самопомощи, прошла личную терапию. Сейчас я в устойчивой ремиссии более двух лет и помогаю другим — как волонтёр в этом сообществе и как специалист в индивидуальной работе.</p><p>«Маяк поддержки» родился из живого опыта и желания создать место, где не нужно объяснять, почему сейчас трудно.</p><a className="textLink" href="#therapy">Моя история и программы →</a></div></section>
      ...
      <section className="therapy section" id="therapy"><div className="wrap"><div className="sectionHead"><div><p className="eyebrow light">О специалисте</p><h2>Профессиональная помощь<br/>от психолога, который прошёл этот путь</h2></div><p>Я соединяю профессиональные знания с человеческой теплотой и пониманием, которое не даётся учебниками.</p></div><div className="qualification"><span>ЛГ</span><div><h3>Лидия Гуринович</h3><p>Практикующий психолог. Опыт ведения групп поддержки и индивидуального консультирования людей с депрессией и биполярным расстройством. Собственный путь устойчивой ремиссии — более двух лет.</p></div></div><div className="programs"><article><small>Индивидуально</small><h3>Личная терапия</h3><p>Онлайн, 50 минут. Интегративный подход с опорой на КПТ, терапию принятия и ответственности и арт-терапевтические техники.</p><ul><li>Депрессивные состояния и апатия</li><li>Эмоциональная неустойчивость при БАР</li><li>Потеря смыслов и профилактика рецидивов</li></ul><p className="placeholder">Стоимость и пакеты встреч — уточняются лично</p><a className="button primary" href={PERSONAL_GEMSPACE} target="_blank" rel="noreferrer">Записаться</a></article><article><small>Группа до 8 человек</small><h3>«Свет внутри»</h3><p>8 онлайн-встреч по 1,5 часа. Арт-терапия помогает выразить чувства, на которые не хватает слов, и найти ресурсы через творчество.</p><ul><li>Художественные навыки не требуются</li><li>Бережный путь от пустоты к контакту с собой</li><li>Дата старта и стоимость — скоро</li></ul><p className="placeholder">Оставьте заявку, чтобы узнать о ближайшем потоке</p><a className="button primary" href={PERSONAL_GEMSPACE} target="_blank" rel="noreferrer">Узнать подробнее</a></article></div><p className="separation">Платные программы — отдельная от бесплатной группы деятельность. Никто из участников не обязан обращаться к специалисту платно, и это не влияет на участие в сообществе.</p></div></section>
